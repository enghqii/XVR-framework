...
public class XvrSprite extends XvrQuad {
	...
	public void draw(XvrTexture tex,float x,float y,float scaleX,float scaleY,float rotation){
	...
	public void setMatrix(float textureWidth, float textureHight){
